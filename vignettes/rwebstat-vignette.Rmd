...
You can find operating procedure at these links ( [fr](http://webstat.banque-france.fr/Portail_API/Webstat_API_FR.pdf) and [en](http://webstat.banque-france.fr/Portail_API/Webstat_API_EN.pdf) )
...
[Webstat](http://webstat.banque-france.fr/en/) offers more than 40 Datasets. The <code>w_datasets()</code> function returns the datasets catalogue :
...
[Webstat](http://webstat.banque-france.fr/en/) corrently offers more than 40.000 Series. The <code>w_series_list()</code> function returns the series catalogue.
